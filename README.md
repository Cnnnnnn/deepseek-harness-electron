...
- **macOS**（Intel + Apple Silicon 通用，推荐 DMG）：[DeepSeek.Harness-universal-mac.dmg](https://github.com/Cnnnnnn/deepseek-harness-electron/releases/latest/download/DeepSeek.Harness-universal-mac.dmg)（或 [zip](https://github.com/Cnnnnnn/deepseek-harness-electron/releases/latest/download/DeepSeek.Harness-universal-mac.zip)）
